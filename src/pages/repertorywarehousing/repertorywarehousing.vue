<template>
	<div class="repertorywarehousing">
		<div class="title">
			<span id="box"></span>
			<span>商品入库</span>
		...
		<div class="content">
			...
			<div class="center">
				<ul>
					...
					<li>
						<div>
							<span>输入搜索:</span>
							<input type="text" name="" id="" value="" placeholder="商品名称/商品货号" />
			...
			<div class="bottom">
				...
				<el-table :data="tableData" border style="width: 100%">
					...
					<el-table-column prop="picture" label="商品照片" width="100">
					</el-table-column>
					<el-table-column prop="goodsname" label="商品名称" width="150">
					</el-table-column>
					<el-table-column prop="goodsnumber" label="货号/属性">
					</el-table-column>
					<el-table-column prop="orderAmount" label="订单号" >
					</el-table-column>
					<el-table-column prop="store" label="库存" width="80">
					</el-table-column>
					<el-table-column prop="storetype" label="库存类型" width="120">
					</el-table-column>
					<el-table-column prop="operationtype" label="操作类型" width="80">
					</el-table-column>
					<el-table-column prop="operationmessage" label="操作信息" width="120">
					</el-table-column>
				</el-table>
...
<style scoped="scoped" lang="scss">
	@import "repertorywarehousing.scss"
